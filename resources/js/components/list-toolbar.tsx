            ...
            <div className="flex items-center justify-end gap-2">
                ...
                >
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem
                            className="text-destructive hover:cursor-pointer focus:text-destructive dark:bg-destructive/50 dark:text-red-50 dark:hover:bg-destructive dark:hover:text-white"
                ...
                {hasSelection ? (
                    <Button
                        variant="secondary"
                        className="text-destructive hover:cursor-pointer hover:bg-destructive hover:text-white dark:bg-destructive/60 dark:text-gray-300 dark:hover:bg-destructive dark:hover:text-white"
